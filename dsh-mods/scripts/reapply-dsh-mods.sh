...
#
# 背景：费用预估/CostMeter/账单/粘贴图片 等功能都是对安装包内文件的直接修改。
...
readonly PATCHES=(
  ...
  "node_modules/@deepseek-ai/dsh-host-apiproxy/lib/index.js|node_modules/@deepseek-ai/dsh-host-apiproxy/lib/index.orig.js|image-relay-patch|dsh-host-apiproxy.patch"
  "node_modules/@deepseek-ai/dsh-llm-deepseek/lib/index.js|node_modules/@deepseek-ai/dsh-llm-deepseek/lib/index.orig.js|image-relay-patch|dsh-llm-deepseek.patch"
